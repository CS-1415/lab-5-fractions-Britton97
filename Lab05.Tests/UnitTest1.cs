...
namespace Lab05.Tests
{
    public class Tests
    {
        ...
        public void Test_RationalNumber_Equality()
        {
            ...
            // This uses the overridden Equals method to compare the two objects
            Assert.That(rational1, Is.EqualTo(rational2)); // Should pass if Equals is properly overridden
        }
